...
<div class="flex min-h-screen flex-col md:flex-row">
    ...
    <aside class="relative hidden min-h-screen flex-col overflow-hidden bg-gradient-to-br from-[#0EA5E9] via-[#0284C7] to-[#333333] text-white md:flex md:w-[46%] lg:w-[48%]">
        ...
        <div class="relative z-10 flex flex-1 flex-col justify-center px-10 pt-16 pb-8 xl:px-14">
        ...
        <div class="relative z-10 flex gap-3 border-t border-white/10 px-10 pt-10 pb-12 xl:px-14">
