                    ...
                    @forelse ($clientes as $cliente)
                        <tr class="hover:bg-accent-50/40">
                            ...
                            <td class="table-cell text-right tabular-nums font-semibold {{ (float) $cliente->saldo_total > 0 ? 'text-red-700' : 'text-neutral-700' }}">
                                {{ \App\Support\CuentaCorriente\CuentaCorrienteMovimientosConsulta::formatearMoneda((float) $cliente->saldo_total) }}
                            </td>
                    ...
                    <tfoot class="bg-accent-50/60 border-t border-accent-200">
                        <tr>
                            ...
                            <td class="table-cell text-right tabular-nums font-semibold {{ $saldoTotal > 0 ? 'text-red-700' : 'text-neutral-700' }}">
                                {{ \App\Support\CuentaCorriente\CuentaCorrienteMovimientosConsulta::formatearMoneda($saldoTotal) }}
                            </td>
