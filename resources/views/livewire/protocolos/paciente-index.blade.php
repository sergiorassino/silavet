            ...
            <x-vl-hero-heading>
                ...
                <p class="mt-1 text-sm text-white/80">
                    ...
                    @else
                        ...
                        @if ($rangoHistorial)
                            Historial de protocolos ({{ $rangoHistorial }}).
                        @else
            ...
            <div class="flex flex-col gap-2 sm:flex-row sm:flex-wrap sm:items-center sm:gap-3 shrink-0">
                ...
                @elseif ($vista === 'historial')
                    <div class="vl-pacientes-fecha-filtro inline-flex items-center gap-2 text-xs font-semibold text-neutral-600">
                        ...
                        <label for="pacFechaHasta" class="whitespace-nowrap">Hasta</label>
                ...
                <thead>
                    <tr>
                        ...
                        @if ($mostrarColumnaPagado)
                            <th class="vl-pacientes-th vl-pacientes-th--num" title="Importe pagado">Pagado</th>
                        @endif
                        @if ($mostrarCadete)
                    ...
                    @forelse ($pacientes as $paciente)
                        @if ($paciente->esPagoGlobal())
                            <tr id="pac-row-{{ $paciente->idPacientes }}"
                                ...
                                <td class="vl-pacientes-td vl-pacientes-td--icon"></td>
                                @if ($mostrarColumnaPagado)
                                    <td class="vl-pacientes-td vl-pacientes-td--num whitespace-nowrap">—</td>
