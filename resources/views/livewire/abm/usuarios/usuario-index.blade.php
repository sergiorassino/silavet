                            ...
                            <td class="table-cell">
                                <div class="flex items-center justify-center gap-0.5">
                                    ...
                                    <x-vl-grid-icon-btn title="Eliminar usuario"
                                                        ...
                                                        x-on:click="window.vlSwalConfirmar('¿Eliminar al usuario «{{ addslashes($usuario->apenom) }}»? Esta acción no se puede deshacer.', 'Eliminar usuario', { confirmButtonText: 'Sí, eliminar', icon: 'warning' }).then(ok => ok && $wire.eliminar({{ $usuario->idUsuarios }}))">
                                        <svg class="h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.75"
