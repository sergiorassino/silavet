...
/**
 * Listado de clientes con saldo (variante tesoreria_pacientes) — TCPDF vertical A4.
 * Misma disposición visual que CuentaCorrienteClientesTcpdf.
 */
final class CuentaCorrienteMovimientosClientesTcpdf extends TCPDF
{
    ...
    private function dibujar(): void
    {
        ...
        foreach ($filas as $fila) {
            ...
            $this->Cell($w[3], 5, CuentaCorrienteMovimientosConsulta::formatearMoneda((float) ($fila->saldo_total ?? 0)), 1, 1, 'R');
        }
        ...
        $this->Cell($w[3], 5, CuentaCorrienteMovimientosConsulta::formatearMoneda((float) ($this->datos['saldo_total'] ?? 0)), 0, 1, 'R');
    }
