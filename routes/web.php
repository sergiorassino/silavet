...
Route::middleware(['auth', 'lab.context'])->group(function () {
    ...
    Route::prefix('tesoreria/movimientos')->middleware(['menu.portal:staff', 'permiso:6', 'tesoreria.modulo'])->group(function () {
    ...
    if (TesoreriaConfig::usaPacientes()) {
        Route::prefix('tesoreria/movimientos-entre-cuentas')->middleware(['menu.portal:staff', 'permiso:6', 'tesoreria.modulo'])->group(function () {
            Route::get('/', MovimientosEntreCuentas::class)->name('tesoreria.movimientos-entre-cuentas.index');
        });

        Route::prefix('tesoreria/saldos-por-dia')->middleware(['menu.portal:staff', 'permiso:6', 'tesoreria.modulo'])->group(function () {
            Route::get('/', SaldosPorDiaIndex::class)->name('tesoreria.saldos-por-dia.index');
        });

        Route::prefix('tesoreria/conceptos')->middleware(['menu.portal:staff', 'permiso:6', 'tesoreria.modulo'])->group(function () {
        ...
        Route::prefix('tesoreria/proveedores')->middleware(['menu.portal:staff', 'permiso:6', 'tesoreria.modulo'])->group(function () {
    ...
    if (TesoreriaConfig::usaMovimientos()) {
        Route::prefix('tesoreria/transferencias')->middleware(['menu.portal:staff', 'permiso:6', 'tesoreria.modulo'])->group(function () {
            Route::get('/', TransferenciaIntercuenta::class)->name('tesoreria.transferencias.index');
        });

        Route::prefix('tesoreria/cuentas')->middleware(['menu.portal:staff', 'permiso:6', 'tesoreria.modulo'])->group(function () {
        ...
        Route::prefix('tesoreria/cuentas-detalle')->middleware(['menu.portal:staff', 'permiso:6', 'tesoreria.modulo'])->group(function () {
    ...
    Route::prefix('protocolos')->middleware(['menu.portal:staff', 'permiso:3'])->group(function () {
        ...
        Route::get('/hoja-ruta-hemograma', HojaRutaHemogramaPdfController::class)
            ->middleware(['throttle:20,1', 'no-store'])
            ->name('protocolos.hoja-ruta-hemograma');
