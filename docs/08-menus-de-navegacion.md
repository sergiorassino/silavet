...
| `gestion-conceptos` | Gestión de Conceptos (Tesorería / tesoreria_pacientes) |
| `gestion-proveedores` | Gestión de Proveedores (Tesorería / tesoreria_pacientes) |
...
| `clientes-resumen-mensual` | Clientes Resumen Mensual (Listados Estadísticos) |
